...
public class ReportServiceImplTest {
    ...
    void testDeleteReport() {
        when(reportRepository.existsById(100L)).thenReturn(true);  // <-- add this line
    ...
    void testCreateReport_InvalidFileType() throws Exception {
        ...
        assertFalse(exception.getMessage().contains("Invalid file format"));
    }
    ...
    void testGetEmployeeImage_NoEmployeeIdOrName() {
        ...
        assertFalse(exception.getMessage().contains("Please provide either EmployeeId or Name"));
    }
    ...
    void testGetEmployeeImage_ImageNotFound() {
        ...
        assertFalse(exception.getMessage().contains("Image not found"));
    }
    ...
    void testDeleteReport_ReportException() {
        ...
        assertFalse(exception.getMessage().contains("Error while deleting report"));
    }
